...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2025 a las 16:42:50
...
--
-- Indices de la tabla `asignacionartista`
--
ALTER TABLE `asignacionartista`
...
--
-- Indices de la tabla `comunicacionsolicitud`
--
ALTER TABLE `comunicacionsolicitud`
...
--
-- Indices de la tabla `historialsolicitud`
--
...
--
-- Indices de la tabla `pantillapersonalizacion`
--
ALTER TABLE `pantillapersonalizacion`
...
--
-- Indices de la tabla `revisionartista`
--
ALTER TABLE `revisionartista`
  ADD PRIMARY KEY (`idRevision`),
  ADD KEY `idSolicitud` (`idSolicitud`),
  ADD KEY `idArtista` (`idArtista`);

--
-- Indices de la tabla `solicitudpersonalizacion`
--
ALTER TABLE `solicitudpersonalizacion`
...
--
-- AUTO_INCREMENT de la tabla `asignacionartista`
--
ALTER TABLE `asignacionartista`
...
--
ALTER TABLE `barrio`
  MODIFY `idBarrio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT de la tabla `comunicacionsolicitud`
--
ALTER TABLE `comunicacionsolicitud`
  MODIFY `idComunicacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `historialsolicitud`
--
ALTER TABLE `historialsolicitud`
...
--
-- AUTO_INCREMENT de la tabla `pantillapersonalizacion`
--
ALTER TABLE `pantillapersonalizacion`
  MODIFY `idPlantilla` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT de la tabla `revisionartista`
--
ALTER TABLE `revisionartista`
  MODIFY `idRevision` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `solicitudpersonalizacion`
--
ALTER TABLE `solicitudpersonalizacion`
...
--
ALTER TABLE `artista`
  ADD CONSTRAINT `artista_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `asignacionartista`
--
ALTER TABLE `asignacionartista`
  ADD CONSTRAINT `asignacionartista_ibfk_1` FOREIGN KEY (`idSolicitud`) REFERENCES `solicitudpersonalizacion` (`idSolicitud`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `asignacionartista_ibfk_2` FOREIGN KEY (`idArtista`) REFERENCES `artista` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `barrio`
--
ALTER TABLE `barrio`
  ADD CONSTRAINT `barrio_ibfk_1` FOREIGN KEY (`idLocalidad`) REFERENCES `localidad` (`idLocalidad`) ON UPDATE CASCADE;
...
ALTER TABLE `cliente`
  ...
  ADD CONSTRAINT `cliente_ibfk_2` FOREIGN KEY (`idBarrio`) REFERENCES `barrio` (`idBarrio`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `comunicacionsolicitud`
--
ALTER TABLE `comunicacionsolicitud`
  ADD CONSTRAINT `comunicacionsolicitud_ibfk_1` FOREIGN KEY (`idSolicitud`) REFERENCES `solicitudpersonalizacion` (`idSolicitud`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `comunicacionsolicitud_ibfk_2` FOREIGN KEY (`idRemitente`) REFERENCES `usuario` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `comunicacionsolicitud_ibfk_3` FOREIGN KEY (`idDestinatario`) REFERENCES `usuario` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `historialsolicitud`
--
ALTER TABLE `historialsolicitud`
  ADD CONSTRAINT `historialsolicitud_ibfk_1` FOREIGN KEY (`idSolicitud`) REFERENCES `solicitudpersonalizacion` (`idSolicitud`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `historialsolicitud_ibfk_2` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `inventario`
--
ALTER TABLE `inventario`
  ADD CONSTRAINT `inventario_ibfk_1` FOREIGN KEY (`idMaterial`) REFERENCES `material` (`idMaterial`) ON UPDATE CASCADE,
  ADD CONSTRAINT `inventario_ibfk_2` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `movimientoinventario`
--
ALTER TABLE `movimientoinventario`
  ADD CONSTRAINT `movimientoinventario_ibfk_1` FOREIGN KEY (`idInventario`) REFERENCES `inventario` (`idInventario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `movimientoinventario_ibfk_2` FOREIGN KEY (`idSolicitud`) REFERENCES `solicitudpersonalizacion` (`idSolicitud`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `movimientoinventario_ibfk_3` FOREIGN KEY (`idArtista`) REFERENCES `artista` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pantillapersonalizacion`
--
ALTER TABLE `pantillapersonalizacion`
  ADD CONSTRAINT `pantillapersonalizacion_ibfk_1` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `producto`
  ...
  ADD CONSTRAINT `producto_ibfk_2` FOREIGN KEY (`idMaterial`) REFERENCES `material` (`idMaterial`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `revisionartista`
--
ALTER TABLE `revisionartista`
  ADD CONSTRAINT `revisionartista_ibfk_1` FOREIGN KEY (`idSolicitud`) REFERENCES `solicitudpersonalizacion` (`idSolicitud`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `revisionartista_ibfk_2` FOREIGN KEY (`idArtista`) REFERENCES `artista` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `solicitudpersonalizacion`
--
ALTER TABLE `solicitudpersonalizacion`
  ADD CONSTRAINT `solicitudpersonalizacion_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `solicitudpersonalizacion_ibfk_2` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `solicitudpersonalizacion_ibfk_3` FOREIGN KEY (`idPlantilla`) REFERENCES `pantillapersonalizacion` (`idPlantilla`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
